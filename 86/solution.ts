...
function countSmaller(nums: number[]): number[] {
  ...
  [   -   ,   -   ,   -   ,1 0]
  [   -   ,   -   ,6 1,1 0]
  [   -   ,2 1,6 2++,1 0] // increment all larger numbers' counters (6)
  [5 2,2 1,6 3++,1 0] // (6)
  [7,3,9,5,2,6,1]
  [   -   ,   -   ,   -   ,5 2,2 1,6 3,1 0] // to generate a new number, add the largest one lower 
  [   -   ,   -   ,9 3+1(4),5 2,2 1,6 3,1 0]     // ... and add one (to include the largest lower number, too)
  [   -   ,3 1+1(2),9 5++,5 3++,2 1,6 4++,1 0] // generate
  [7 4+1(5),3 2,9 6++,5 3,2 1,6 4,1 0] // generate
  [7:5
  ,3:2
  ,9:6
  ,5:3
  ...
  ,6:4
  ,1:0]
  // pq = 9:6 7:5 6:4 5:3 3:2 2:1 1:0
  - looking for the next number, pop until you find it 
      ...
      pq = 9:6 6:4 5:3 3:2 2:1 1:0, next = 7
      outqueue = []
  ...
  - adding takes only logn time 
      - this gives a worst case of n + log n (O(n)), and a best case of 2 (O(1))
  */
